...
- [x] Run `SFTTrainer` for 2–3 epochs; use `save_steps=50` to checkpoint to Drive
- [x] Monitor training loss — target final loss < 1.5
- [x] Save final adapter weights: `llama-3.2-3b-arxiv-lora/`
- [x] Push adapter to HuggingFace Hub with a model card
